...
type InactiveStudentModalContentProps = {
  onClose: () => void;
};

const InactiveStudentModalContent = ({
  onClose,
}: InactiveStudentModalContentProps) => {
        ...
        >
          <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-center">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  >
                    {i18n.t('inactiveStudent_title')}
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-purple-900">
                      {i18n.t('inactiveStudent_subtext')}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex flex-col sm:px-6">
              ...
              >
                {i18n.t('inactiveStudent_profileButton')}
              </button>
            </div>
          </Dialog.Panel>
        </Transition.Child>
...
export default InactiveStudentModalContent;
